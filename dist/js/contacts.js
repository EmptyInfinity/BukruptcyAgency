...
var mymap = L.map('mapid').setView([50.4442, 30.49755], 16);
...
L.marker([50.4442, 30.497551]).addTo(mymap)
  .bindPopup("<h3 class='map-h3' >Banckruptcy agency</h3><p class = 'map-p' >Киев, ул. Симона Петлюри , 16/108</p>").openPopup();
